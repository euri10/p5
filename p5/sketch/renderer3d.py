...
from ..core.material import BasicMaterial, BlinnPhongMaterial, NormalMaterial
...
class Renderer3D(OpenGLRenderer):
    ...
    def _update_shader_transforms(self):
        ...
        # This is a no-op, meaning that the normals stay in world space,
        # which matches the behavior in p5.js
        ...
        # normal_transform = np.linalg.inv(self.projection_matrix[:3, :3] @ self.lookat_matrix[:3, :3])  # noqa: E501
    ...
    def add_to_draw_queue(
        ...
        // TODO: Unite style-related attributes for both 2D and 3D under one material
        class
        """
    ...
    def render_with_shaders(self, draw_type, draw_obj):
        ...
        # 0. If material does not need normals nor extra info,
        # strip them out and use the method from superclass
        if (
            material is None
    ...
    def flush_geometry(self):
        ...
        for index, shape in enumerate(self.draw_queue):
            ...
            if current_shape == "lines":
                ...
                # We transform the points to camera space, move them by Z_EPSILON,
                # and them move them back to world space
