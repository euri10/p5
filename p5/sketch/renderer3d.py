...
from p5.sketch.openglrenderer import OpenGLRenderer, to_3x3, get_render_primitives
from p5.sketch.shaders3d import src_fbuffer, src_normal, src_default, src_phong
