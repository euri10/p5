...
class Renderer2D(OpenGLRenderer):
    ...
    def render_line(self, queue):
        ...
        Reference: https://blog.mapbox.com/drawing-antialiased-lines-with-opengl-8766f34192dc  # noqa: E501
        """
    ...
    def render_image(self, image, location, size):
        ...
        self.texture_prog["fill_color"] = (
            self.tint_color if self.tint_enabled else self.COLOR_WHITE
        )
